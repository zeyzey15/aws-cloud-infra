...
# Attach all policies to the user
resource "aws_iam_user_policy_attachment" "attach_compute" {
  user       = aws_iam_user.tf_manager.name
  policy_arn = aws_iam_policy.compute_limited_free_tier.arn
}

resource "aws_iam_user_policy_attachment" "attach_storage" {
  user       = aws_iam_user.tf_manager.name
  policy_arn = aws_iam_policy.storage_limited_free_tier.arn
}

resource "aws_iam_user_policy_attachment" "attach_dynamodb" {
  user       = aws_iam_user.tf_manager.name
  policy_arn = aws_iam_policy.dynamodb_limited_free_tier.arn
}
